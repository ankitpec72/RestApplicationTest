...
public class RESTArticleServiceImpl implements RESTArticleService {
	 ...
	 */
	@Override
	public Response retrieveArticle(String articleId) {
		...
		return Response.status(Response.Status.OK).entity(ArticleServiceHelper.convertEntityToView(existingArticle))
